export default function customerPaymentHistory() {
    return (
        ...
        <h2 className="text-2xl font-bold mb-4 text-center text-[#23a888]">Payment History</h2>
      
        <div className="flex flex-col items-center justify-center text-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-200 h-20 mx-auto mb-4 text-[#dc5777]">
